...
function MiCvPage() {
    ...
    const [nombreArchivoActual, setNombreArchivoActual] = useState('curriculo-demo.pdf');
    ...
    function subirCurriculo(event: FormEvent<HTMLFormElement>) {
        ...
        setMensaje('Currículo actualizado correctamente. Luego se conectará con el backend REST.');
    }
